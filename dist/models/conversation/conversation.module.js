...
exports.ConversationsModule = ConversationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [conversation_service_1.ConversationsService, conversation_resolver_1.ConversationsResolver],
        exports: [conversation_service_1.ConversationsService],
    })
], ConversationsModule);
