...
const Chat: React.FC<ChatProps> = ({ pp, contact, msg, time, unreadMsgs, active }) => {
  return (
    // Chat container
    <div
    ...
    >
      ...
      <div className="flex justify-between border-t border-neutral-700 w-100 h-100 py-3">
        ...
        <div className="flex flex-col justify-between items-end h-100 text-xs">
          ...
          {/* Number of messages */}
          {unreadMsgs && (
            <div className="flex justify-center items-center bg-[#24D26D] rounded-full w-[20px] h-[20px]">
