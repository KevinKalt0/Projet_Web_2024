    ...
    <div className="flex flex-col border-r border-neutral-700 w-100 h-screen">
      ...
      <div className="flex justify-between items-center h-[60px] p-2">
        ...
        <input
          ...
          className="rounded-lg bg-[#211A44] text-[#E3BAD5] text-sm font-light outline-none px-4 py-2 w-[400px] h-[35px] placeholder:text-[#8796a1] placeholder:text-sm placeholder:font-light"
        />
